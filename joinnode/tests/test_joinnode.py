...
class TestJoinAccumulator(unittest.TestCase):
    ...
    def test_query_2_revenue_frees_space(self):
        result_grouper = MockCopyMiddleware()
        in_left = ["product_id","product_name"]
        in_right = ["top_product_id","month","revenue",]
        out_cols = ["product_id","product_name","month","revenue",]
        ...
        self.assertEqual(node.len_left_rows(), len(rows_left))
        ...
        self.assertEqual(node.len_in_progress(), 1)
        self.assertEqual(node.len_left_rows(), len(rows_left))
        self.assertEqual(node.len_input_rows(), len(rows_left)+len(rows_right))
        self.assertEqual(node.len_out_rows(), 0)
        ...
        self.assertEqual(node.len_left_rows(), len(rows_left))
        self.assertEqual(node.len_input_rows(), len(rows_left))
        self.assertEqual(node.len_out_rows(), len(expected_out))
        ...
        self.assertEqual(node.len_left_rows(), 0)
        self.assertEqual(node.len_input_rows(), 0)
        self.assertEqual(node.len_out_rows(), 0)
