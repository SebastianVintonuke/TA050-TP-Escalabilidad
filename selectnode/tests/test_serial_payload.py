...
class TestSerialPayload(unittest.TestCase):
    ...
    def test_serial_deserial_csv_message(self):
        ...
        res_msg = CSVMessage(None, MethodClass("Something"), msg_build.get_headers(), payload)
        res_msg.describe()
    ...
    def test_serial_deserial_hashed_csv_message(self):
        msg_build = CSVHashedMessageBuilder(["8845cdaa-d230-4453-bbdf-0e4f783045bf,76.5"], ["query_1"], "KEY_HASH_1")
