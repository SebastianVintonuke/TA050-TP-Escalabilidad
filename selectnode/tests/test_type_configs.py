import unittest
from selectnode.src.base_type_config import * 
...
def map_dict_to_vect(row):
    return [
        row["year"], row["month"], row["hour"], row["product_id"]
    ]
...
class TestTypeConfigs(unittest.TestCase):
    def build_simple_base_config(self, result_grouper):
        ...
        config_type = BaseTypeConfiguration(result_grouper, MockMessageBuilder, in_fields_count =in_fields_count)
    ...
    def build_simple_base_dict_config(self, result_grouper):
        ...
        config_type = BaseDictTypeConfiguration(result_grouper, MockMessageBuilder,
             in_fields =in_fields, out_conf = config)
        return config_type
    ...
    def build_simple_select_config(self, result_grouper, filters_serial):
        ...
        config_type= SelectTypeConfiguration(result_grouper, MockMessageBuilder, in_fields = in_fields, filters_conf=filters_serial, out_conf = config)
