...
def main() -> None:
    ...
    try:
        ...
        types_config[QUERY_1] = SelectTypeConfiguration(
            result_middleware,
        ...
        types_config[QUERY_2] = SelectTypeConfiguration(
            result_middleware,
            csv_message.csv_msg_from_msg,
        ...
        types_config[QUERY_3] = SelectTypeConfiguration(
            result_middleware,
            csv_message.csv_msg_from_msg,
            in_fields=[
                "transaction_id",
        ...
        types_config[QUERY_4] = SelectTypeConfiguration(
            result_middleware,
            csv_message.csv_msg_from_msg,
