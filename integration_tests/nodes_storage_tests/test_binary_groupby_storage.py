...
from groupbynode.src.groupby_state_manager_binary import BinaryGroupbyStateManager, QueryAccumulator
...
class TestBinaryGroupbyStorage(unittest.TestCase):
    ...
    def test_simple_query_state_storage_creates_dirs(self):
        ...
        state_storage = q_state.QueryStateStorage("initial_folder", BinaryGroupbyStateManager(get_accum_mock))
    ...
    def test_query_2_groupbynode_with_storage_no_recovery_single_msg(self):
        ...
        node = GroupbyNode(in_middle, MockMessage, conf_map, state_manager_creator = BinaryGroupbyStateManager,store_creator = self.creator_storage)
        node.start()
    ...
    def test_query_2_groupbynode_with_storage_no_recovery_but_batch_size_ack(self):
        ...
        node = GroupbyNode(in_middle, MockMessage, conf_map, state_manager_creator = BinaryGroupbyStateManager,store_creator = self.creator_storage, batch_size = batch_size) # Each 2 messages 
        node.start()
    ...
    def test_query_2_groupbynode_with_no_recovery_but_batch_size_store_of_states(self):
        ...
        retrieve_storage = self.creator_storage(BinaryGroupbyStateManager(get_accum_mock))
